...
use Math::GSL::Linalg qw/gsl_linalg_LU_decomp gsl_linalg_LU_det gsl_linalg_LU_lndet/;
...
Returns true is a matrix is square, i.e. it has the same number of rows as columns, false otherwise.
...
sub det($)
{
    ...
    my $s = gsl_linalg_LU_decomp($LU->raw, $p->raw);
